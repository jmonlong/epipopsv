---
title: Bias in Whole-Genome Sequencing Coverage
author: Jean Monlong
output:
  md_document:
...
# Bias in Whole-Genome Sequencing Coverage
...
normQN <- function(df,sample.names){
  rownames(df) = NULL
  quant.o = apply(apply(df[,sample.names], 2, sort, na.last=TRUE), 1, median, na.rm=TRUE)
...
### Removing the 5 most affected samples

```{r}
samples2 = as.character(head(samp.o$sample, nrow(samp.o)-5))
