...
```{r, echo=FALSE}
save(enr.obs, enr.exp.diff, enr.obs.diff, rare.ex.f, rare.ex.f.noext, rare.ex.fc, cnb.nc, cnb.nc.del, cnb.df, gene.sum.n, test.df, test.epi.genes, enr.epi.freq, file='epilepsy-enrichmentPatterns.RData')
```
