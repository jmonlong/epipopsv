...
ggplot(ex.enr, aes(x=feat, fill=project, y=enr)) + geom_boxplot() + theme_bw() + xlab("") + ylab("fold-enrichment") + scale_x_discrete(breaks=c("exon","exon.pli"), labels=c("all genes", "LoF\nintolerant\ngenes")) + facet_grid(.~set) + geom_hline(yintercept=1, linetype=2)
```
